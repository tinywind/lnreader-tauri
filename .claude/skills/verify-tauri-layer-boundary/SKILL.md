...
description: Verify Norea UI, state, IPC, Rust runtime, Drizzle, plugin fetch, reader, and validation responsibilities stay in their layers.
---
...
- SQLite/Drizzle schema and query details stay in DB/persistence modules.
